...
impl ByTextOptions {
    /// Create a new empty ByTextOptions
    pub fn new() -> Self {
        Self::default()
    }
...
mod tests {
    ...
    #[test]
    fn test_text_options_empty_serialization() {
        let options = ByTextOptions::new();
        let json = options.to_json_string().unwrap();
        assert_eq!(json, "{}");
    }

    #[test]
    fn test_text_options_exact_true_serialization() {
    ...
    #[test]
    fn test_text_options_exact_false_serialization() {
        let options = ByTextOptions::new().exact(false);
    ...
    #[test]
    fn test_text_options_json_string() {
        let options = ByTextOptions::new().exact(true);
