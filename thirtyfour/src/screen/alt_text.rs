...
/// Options for alt text queries
#[derive(Debug, Clone, Default, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct ByAltTextOptions {
    /// Whether to use exact text matching
    #[serde(skip_serializing_if = "Option::is_none")]
    pub exact: Option<bool>,
}

impl ByAltTextOptions {
    /// Create a new empty ByAltTextOptions
    pub fn new() -> Self {
        Self::default()
    }
...
mod tests {
    ...
    #[test]
    fn test_alt_text_options_empty_serialization() {
        let options = ByAltTextOptions::new();
        let json = options.to_json_string().unwrap();
        assert_eq!(json, "{}");
    }

    #[test]
    fn test_alt_text_options_exact_true_serialization() {
        let options = ByAltTextOptions::new().exact(true);
    ...
    #[test]
    fn test_alt_text_options_exact_false_serialization() {
        let options = ByAltTextOptions::new().exact(false);
    ...
    #[test]
    fn test_alt_text_options_json_string() {
        let options = ByAltTextOptions::new().exact(true);
