...
impl ByTestIdOptions {
    /// Create a new empty ByTestIdOptions
    pub fn new() -> Self {
        Self::default()
    }
...
mod tests {
    ...
    #[test]
    fn test_test_id_options_empty_serialization() {
        let options = ByTestIdOptions::new();
        let json = options.to_json_string().unwrap();
        assert_eq!(json, "{}");
    }

    #[test]
    fn test_test_id_options_exact_true_serialization() {
        let options = ByTestIdOptions::new().exact(true);
    ...
    #[test]
    fn test_test_id_options_exact_false_serialization() {
        let options = ByTestIdOptions::new().exact(false);
    ...
    #[test]
    fn test_test_id_options_json_string() {
        let options = ByTestIdOptions::new().exact(true);
