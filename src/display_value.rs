...
impl ByDisplayValueOptions {
    /// Create a new empty ByDisplayValueOptions
    pub fn new() -> Self {
        Self::default()
    }
...
mod tests {
    ...
    #[test]
    fn test_display_value_options_empty_serialization() {
        let options = ByDisplayValueOptions::new();
        let json = options.to_json_string().unwrap();
        assert_eq!(json, "{}");
    }

    #[test]
    fn test_display_value_options_exact_true_serialization() {
        let options = ByDisplayValueOptions::new().exact(true);
    ...
    #[test]
    fn test_display_value_options_exact_false_serialization() {
        let options = ByDisplayValueOptions::new().exact(false);
    ...
    #[test]
    fn test_display_value_options_json_string() {
        let options = ByDisplayValueOptions::new().exact(true);
